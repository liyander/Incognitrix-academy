      ...
      <div className="p-6 md:p-8 border-b border-outline-variant/30 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {sourceUrl && (
          <a
            ...
            className="rounded-xl inline-flex shrink-0 items-center justify-center gap-2 border border-outline-variant px-4 py-3 font-headline text-[10px] font-bold tracking-normal text-on-surface hover:border-primary hover:text-primary transition-colors"
          >
            Open published page
