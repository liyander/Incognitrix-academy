      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="rounded-2xl bg-surface-container-lowest border-l-4 border-primary p-8 mb-8">
          <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <button
              className="rounded-lg bg-surface-container-high text-on-surface px-6 py-2.5 font-headline text-xs font-bold tracking-normal hover:text-secondary transition-colors disabled:opacity-60"
              disabled={syncing}
          ...
          {syncSummary ? (
            <p className="rounded-2xl mb-6 bg-secondary/10 border-l-4 border-secondary p-4 text-secondary font-headline text-xs font-bold tracking-normal">
          ...
          {showForm ? (
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-4 pt-2 md:flex-row md:items-center md:justify-between">
                ...
                <button
                  className="rounded-xl w-full md:w-auto min-w-[220px] bg-primary text-on-primary px-6 py-3 font-headline text-xs font-bold tracking-normal hover:bg-primary-container transition-colors"
                  type="submit"
                >
          ...
          {loading ? (
            ...
            <div className="grid gap-4">
              {events.map((event) => {
                ...
                return (
                  <div className="rounded-2xl bg-surface-container-lowest border-l-4 border-secondary/50 p-6" key={event.id}>
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2 mt-2">
                          <span className={`px-2 py-1 text-[10px] font-headline font-bold tracking-normal ${event.is_active ? 'bg-secondary/15 text-secondary' : 'bg-surface-container-high text-on-surface-variant'}`}>
                          ...
                          {deadlinePassed ? (
                            <span className="rounded-full px-2 py-1 text-[10px] font-headline font-bold tracking-normal bg-error/15 text-error">
                              Deadline Passed
                            </span>
                          ) : null}
                        </div>
