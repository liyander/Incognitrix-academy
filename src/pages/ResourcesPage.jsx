...
function ResourcesPage() {
  ...
  return (
    <main className="rounded-2xl min-h-screen bg-surface px-6 xl:px-10 py-10 mt-16 md:mt-20">
      <div className="max-w-7xl mx-auto space-y-12">
        <header className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="rounded-xl h-0.5 w-8 bg-primary"></span>
          ...
          <p className="text-on-surface-variant font-body text-sm md:text-base max-w-2xl">
            Browse through critical Common Vulnerabilities and Exposures (Resources), 
        ...
        <section>
          <div className="mb-6 max-w-xl">
            <label className="block text-xs font-label tracking-normal text-on-surface-variant mb-2 font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-headline text-lg font-bold tracking-normal text-on-surface group-hover:text-primary transition-colors">
                      {cve.cve_id}
                    </span>
                    <span className="rounded-full bg-surface-container-highest px-2 py-1 text-[10px] font-label font-bold tracking-normal text-on-surface-variant">
                      {cve.found_year}
                    </span>
                  </div>
                ...
                <div className="border-t border-outline-variant pt-4 mt-auto">
                  <p className="font-label text-[10px] text-on-surface-variant tracking-normal truncate">
            ...
            {filteredCves.length === 0 && (
              <div className="rounded-xl col-span-full py-12 text-center bg-surface-container-lowest">
                ...
                <p className="font-headline text-on-surface-variant tracking-normal">No Resources match your query.</p>
              </div>
            )}
          </div>
        </section>
