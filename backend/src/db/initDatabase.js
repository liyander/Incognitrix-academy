...
async function ensureDatabase() {
  ...
  await connection.query(`
    ...
    CREATE TABLE IF NOT EXISTS cves ( id INT AUTO_INCREMENT PRIMARY KEY, cve_id VARCHAR(100) NOT NULL UNIQUE, short_description TEXT NOT NULL, found_year INT, credit VARCHAR(255), vulnerability_report LONGTEXT, method_followed LONGTEXT, references_text LONGTEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP );\n\n    CREATE TABLE IF NOT EXISTS platform_config (
      id INT PRIMARY KEY,
  ...
  if (!configCountRows[0].count) {
    await connection.query(
      'INSERT INTO platform_config (id, routes_json, features_json, ai_json, api_json) VALUES (1, ?, ?, ?, ?)',
      [
